...
\newcommand*{\RQOne}{ Peut-on détecter les odeurs de conception dans les programmes d'apprentissage profond CNN avec la méta-modélisation? }
\newcommand*{\RQTwo}{ Quels sont les odeurs de conception les plus répandu dans les programmes
d'apprentissage profond CNN? }
\newcommand*{\RQThree}{ Exist-il des lien entre les odeurs de conception dans les programmes? }
