...
\newcommand*{\RQOne}{ Comment détecter les défauts de conception dans les programmes d'apprentissage profond? }
\newcommand*{\RQTwo}{ Quels sont les défauts de conception les plus répandu dans les programmes
d'apprentissage profond CNN? }
\newcommand*{\RQThree}{ Exist-il des lien entre les défauts de conception dans les programmes? }
